...
const ShowDataBase = () => {
  ...
  return (
    <>
      <div className=" bg-teal-300 h-screen p-10 flex flex-col justify-center ">
        <div className="bg-gray-100   rounded-lg shadow-lg shadow-black/80 p-5 h-full">
          <div className="py-4 px-24 flex justify-center">
            <input
              type="search"
              className="w-[500px] px-3 py-2 rounded-md text-lg ring-4 shadow-lg  ring-slate-500 focus:ring-blue-500 focus:outline-none relative my-3 mt-0 tracking-wider"
              ...
              <tbody className="text-gray-700 text-md font-light ">
                {
                    cropData.filter((item)=>{
                        return(
                            searchValue.toLowerCase()===""?item:item.name.toLowerCase().includes(searchValue.toLowerCase())
                        )
